    ...
    if ( ! class_exists( 'reduxCoreEnqueue' ) ) {
        class reduxCoreEnqueue {
            ...
            private function set_localized_data() {
                 ...
                 */
                $save_pending = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/save_pending", __( 'You have changes that are not saved. Would you like to save them now?', 'redux-framework-starhotel' ) );
                 ...
                 */
                $reset_all = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/reset", __( 'Are you sure? Resetting will lose all custom values.', 'redux-framework-starhotel' ) );
                 ...
                 */
                $reset_section = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/reset_section", __( 'Are you sure? Resetting will lose all custom values in this section.', 'redux-framework-starhotel' ) );
                 ...
                 */
                $preset_confirm = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/preset", __( 'Your current options will be replaced with the values of this preset. Would you like to proceed?', 'redux-framework-starhotel' ) );
                global $pagenow;
                $this->parent->localize_data['args'] = array(
                    ...
                    'please_wait'           => __( 'Please Wait', 'redux-framework-starhotel' ),
                ...
                $this->parent->localize_data['ajax'] = array(
                    'console' => __( 'There was an error saving. Here is the result of your action:', 'redux-framework-starhotel' ),
                    'alert'   => __( 'There was a problem with your action. Please try again or reload the page.', 'redux-framework-starhotel' ),
                );
