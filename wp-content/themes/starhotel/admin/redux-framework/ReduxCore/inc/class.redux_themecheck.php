                ...
                //if ( ! empty( $redux ) ) {
                    ...
                    if ( isset( $_POST['themename'] ) && ! empty( $_POST['themename'] ) ) {
                        if ( strpos( $dir, $_POST['themename'] ) !== false ) {
                            ...
                            <div class="updated">
                            <p><?php
                                    echo sprintf( __( 'The theme you are testing has %s embedded. We invite you to read the %sTheme-Check Documentation%s to understand some warnings you will see because of Redux.', 'redux-framework-starhotel' ), '<a href="http://reduxframework.com" target="_blank">Redux Framework</a>', '<a href="http://docs.reduxframework.com/core/theme-check/">', '</a>' );
                                ?>
                            </div><?php
                        }
                    }
                    ...
                    if ( ! ReduxFramework::$_is_plugin ) {
                        ...
                        if ( ! empty( $errors ) ) {
                            ...
                            <div class="error">
                            <p><?php
                                    _e( 'The following directories & files are still located in your <strong>Redux</strong>  directory. They may cause errors in Theme-Check.', 'redux-framework-starhotel' );
