    ...
    if ( ! class_exists( 'ReduxDebugObject' ) ) {
        ...
        class ReduxDebugObject {
            ...
            public function render() {
                ...
                echo '<h3>' . __( 'Options Object', 'redux-framework-starhotel' ) . '</h3>';
                ...
                echo '<a href="#" id="consolePrintObject" class="button">' . __( 'Show Object in Javascript Console Object', 'redux-framework-starhotel' ) . '</a>';
            ...
            public function render_tab() {
                ...
                echo '<a href="javascript:void(0);" id="dev_mode_default_section_group_li_a" class="redux-group-tab-link-a custom-tab" data-rel="dev_mode_default">' . $icon . ' <span class="group_title">' . __( 'Options Object', 'redux-framework-starhotel' ) . '</span></a>';
                echo '</li>';
            }
            ...
            public function add_submenu() {
                add_submenu_page(
                    ...
                    __( 'Options Object', 'redux-framework-starhotel' ),
                    __( 'Options Object', 'redux-framework-starhotel' ),
