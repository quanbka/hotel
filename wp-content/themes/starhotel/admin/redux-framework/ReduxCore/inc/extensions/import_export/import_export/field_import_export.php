    ...
    if ( ! class_exists( 'ReduxFramework_import_export' ) ) {
        ...
        class ReduxFramework_import_export extends ReduxFramework {
            ...
            public function render() {
                ...
                <h4><?php _e( 'Import Options', 'redux-framework-starhotel' ); ?></h4>
                <p><a href="javascript:void(0);" id="redux-import-code-button" class="button-secondary"><?php _e( 'Import from File', 'redux-framework-starhotel' ); ?></a> <a href="javascript:void(0);" id="redux-import-link-button" class="button-secondary"><?php _e( 'Import from URL', 'redux-framework-starhotel' ) ?></a></p>

                <div id="redux-import-code-wrapper">
                <p class="description" id="import-code-description"><?php echo apply_filters( 'redux-import-file-description', __( 'Input your backup file below and hit Import to restore your sites options from a backup.', 'redux-framework-starhotel' ) ); ?></p>
                ...
                <p class="description" id="import-link-description"><?php echo apply_filters( 'redux-import-link-description', __( 'Input the URL to another sites options set and hit Import to load the options from that site.', 'redux-framework-starhotel' ) ); ?></p>
                ...
                <p id="redux-import-action"><input type="submit" id="redux-import" name="import" class="button-primary" value="<?php _e( 'Import', 'redux-framework-starhotel' ) ?>">&nbsp;&nbsp;<span><?php echo apply_filters( 'redux-import-warning', __( 'WARNING! This will overwrite all existing option values, please proceed with caution!', 'redux-framework-starhotel' ) ) ?></span></p>

                <div class="hr"/><div class="inner"><span>&nbsp;</span></div></div>
                <h4><?php _e( 'Export Options', 'redux-framework-starhotel' ) ?></h4>
                <div class="redux-section-desc">
                <p class="description"><?php echo apply_filters( 'redux-backup-description', __( 'Here you can copy/download your current option settings. Keep this safe as you can use it as a backup should anything go wrong, or you can use it to restore your settings on this site (or any other site).', 'redux-framework-starhotel' ) ) ?></p>
                </div>
                <?php
                $link = admin_url( 'admin-ajax.php?action=redux_download_options-' . $this->parent->args['opt_name'] . '&secret=' . $secret );
                ?>
                <p><a href="javascript:void(0);" id="redux-export-code-copy" class="button-secondary"><?php _e( 'Copy Data', 'redux-framework-starhotel' ) ?></a> <a href="<?php echo $link; ?>" id="redux-export-code-dl" class="button-primary"><?php _e( 'Download Data File', 'redux-framework-starhotel' ) ?></a> <a href="javascript:void(0);" id="redux-export-link" class="button-secondary"><?php _e( 'Copy Export URL', 'redux-framework-starhotel' ) ?></a></p>
                <p></p>
