    ...
    class ReduxFramework_select_image {
        ...
        function render() {
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                // Process placeholder
                $placeholder = ( isset( $this->field['placeholder'] ) ) ? esc_attr( $this->field['placeholder'] ) : __( 'Select an item', 'redux-framework-starhotel' );
                ...
                echo '<strong>' . __( 'No items of this type were found.', 'redux-framework-starhotel' ) . '</strong>';
            }
        } //function
