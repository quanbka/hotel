    ...
    if ( ! class_exists( 'Redux_Validation_unique_slug' ) ) {
        class Redux_Validation_unique_slug {
            ...
            function __construct( $parent, $field, $value, $current ) {
                ...
                $this->parent                    = $parent;
                $this->field                     = $field;
                $this->field['msg']              = ( isset( $this->field['msg'] ) ) ? $this->field['msg'] : __( 'That URL slug is in use, please choose another. <code>%s</code> is open for use.', 'redux-framework-starhotel' );
