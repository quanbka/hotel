<div class="wrap about-wrap">
    <h1><?php printf( __( 'Welcome to Redux Framework %s', 'redux-framework-starhotel' ), $this->display_version ); ?></h1>

    <div
        class="about-text"><?php printf( __( 'Thank you for updating to the latest version! Redux Framework %s is a huge step forward in Redux Development. Look at all that\'s new.', 'redux-framework-starhotel' ), $this->display_version ); ?></div>
    <div
        class="redux-badge"><i
    ...
    <div id="redux-message" class="updated">
        <h4><?php _e( 'What is Redux Framework?', 'redux-framework-starhotel' ); ?></h4>

        <p><?php _e( 'Redux Framework is the core of many products on the web. It is an option framework which developers use to
            enhance their products.', 'redux-framework-starhotel' ); ?></p>

        <p class="submit">
            <a class="button-primary" href="http://reduxframework.com"
               target="_blank"><?php _e( 'Learn More', 'redux-framework-starhotel' ); ?></a>
        </p>
    </div>

    <div class="changelog">

        <h2><?php _e( 'New in this Release', 'redux-framework-starhotel' ); ?></h2>
