...
<div class="wrap about-wrap">
    <h1><?php _e( 'Redux Framework - Extensions', 'redux-framework-starhotel' ); ?></h1>

    <div
        class="about-text"><?php printf( __( 'Supercharge your Redux experience. Our extensions provide you with features that will take your products to the next level.', 'redux-framework-starhotel' ), $this->display_version ); ?></div>
    <div
        class="redux-badge"><i
    ...
    <p class="about-description"><?php _e( "While some are built specificially for developers, extensions such as Custom Fonts are sure to make any user happy.", 'redux-framework-starhotel' ); ?></p>
