<div class="wrap about-wrap" xmlns="http://www.w3.org/1999/html">
    <h1><?php _e( 'Redux Framework - Support', 'redux-framework-starhotel' ); ?></h1>

    <div
        class="about-text"><?php printf( __( 'We are an open source project used by developers to make powerful control panels.', 'redux-framework-starhotel' ), $this->display_version ); ?></div>
    <div
        class="redux-badge"><i
    ...
    <div id="support_div" class="support">
        ...
        <form id="supportform">
            ...
            <ul id="progressbar" class=" breadcrumb">
                <li class="active"><?php _e( 'Generate a Support URL', 'redux-framework-starhotel' ); ?></li>
                <li href="#"><?php _e( 'Select Support Type', 'redux-framework-starhotel' ); ?></li>
                <li href="#"><?php _e( 'How to Get Support', 'redux-framework-starhotel' ); ?></li>
            </ul>

            <!-- fieldsets -->
            <fieldset>
                <h2 class="fs-title"><?php _e( 'Submit a Support Request', 'redux-framework-starhotel' ); ?></h2>

                <h3 class="fs-title"
                    style="margin-top:0;"><?php _e( 'To get started, we will need to generate a support hash.', 'redux-framework-starhotel' ); ?></h3>

                <p><?php
                        echo sprintf( wp_kses( __( 'This will provide to your developer all the information they may need to remedy your issue. This action WILL send information securely to a remote server. To see the type of information sent, please look at the  <a href="%s">Status tab</a>.', 'redux-framework-starhotel' ), array( 'a' => array( 'href' => array() ) ) ), esc_url( admin_url( 'tools.php?page=redux-status' ) ) );
                    ?>
                </p>

                <p><a href="#" class="docs button button-primary button-large redux_support_hash"><?php _e( 'Generate
                        a Support URL', 'redux-framework-starhotel' ); ?></a></p>
                <input type="button" name="next" class="next hide action-button"
                       value="Next"/>
            </fieldset>

            <fieldset>
                <h2 class="fs-title"><?php _e( 'Select Your Support Type', 'redux-framework-starhotel' ); ?></h2>

                <h3 class="fs-subtitle" style="text-align: center;">
                    <?php _e( 'What type of user are you?', 'redux-framework-starhotel' ); ?>
                </h3>

                <table id="user_type">
                    <tr>
                        <td id="is_user"><i class="el el-user"></i><br/><?php _e( 'User', 'redux-framework-starhotel' ); ?><br/>
                            <small><?php _e( 'I am a user, using a pre-built product.', 'redux-framework-starhotel' ); ?></small>
                        </td>
                        <td id="is_developer"><i
                                class="el el-github"></i><br/><?php _e( 'Developer', 'redux-framework-starhotel' ); ?><br/>
                            <small><?php _e( 'I am a developer, building a product using Redux.', 'redux-framework-starhotel' ); ?></small>
                        </td>
                    </tr>
                </table>
            ...
            <fieldset id="final_support">
                <h2 class="fs-title"><?php _e( 'How to Get Support', 'redux-framework-starhotel' ); ?></h2>

                <div class="is_developer">
                    <p><?php _e( 'Please proceed to the Redux Framework issue tracker and supply us with your support URL below. Please also provide any information that will help us to reproduce your issue.', 'redux-framework-starhotel' ); ?></p>
                ...
                <div class="is_user">
                    ...
                    <!--                    for="p-->
                    <?php //echo $dirname; ?><!--"><strong>--><?php //_e( 'Plugin', 'redux-framework-starhotel' );?>
                    ...
                    <!--            for="-->
                    <?php //echo sanitize_html_class( $active_theme->Name ); ?><!--"><strong>--><?php //_e( 'Theme', 'redux-framework-starhotel' ); ?>
                ...
                <p><em>
                        <?php
                            echo sprintf( wp_kses( __( 'Should the developer not be responsive, read the <a href="%s" target="_blank">following article</a> before asking for support from us directly.', 'redux-framework-starhotel' ), array( 'a' => array( 'href' => array() ) ) ), esc_url( 'http://docs.reduxframework.com/core/support-defined/' ) );
                        ?>
                    </em>
