    ...
    class Redux_Welcome {
        ...
        public function support_hash() {
            ...
            if ( ! empty( $data['identifier'] ) ) {
                ...
                $return['status']  = "error";
                $return['message'] = __( "Support hash could not be generated. Please try again later.", 'redux-framework-starhotel' );
            }
        ...
        public function admin_menus() {
            ...
            // About Page
            add_management_page(
                __( 'Welcome to Redux Framework', 'redux-framework-starhotel' ), __( 'Redux Framework', 'redux-framework-starhotel' ), $this->minimum_capability, 'redux-about', array(
                    $this,
                    'about_screen'
                )
            );
            ...
            // Changelog Page
            add_management_page(
                __( 'Redux Framework Changelog', 'redux-framework-starhotel' ), __( 'Redux Framework Changelog', 'redux-framework-starhotel' ), $this->minimum_capability, 'redux-changelog', array(
                    $this,
                    'changelog_screen'
                )
            );
            ...
            // Support Page
            add_management_page(
                __( 'Get Support', 'redux-framework-starhotel' ), __( 'Get Support', 'redux-framework-starhotel' ), $this->minimum_capability, 'redux-support', array(
                    $this,
                    'get_support'
                )
            );
            ...
            // Support Page
            add_management_page(
                __( 'Redux Extensions', 'redux-framework-starhotel' ), __( 'Redux Extensions', 'redux-framework-starhotel' ), $this->minimum_capability, 'redux-extensions', array(
                    $this,
                    'redux_extensions'
                )
            );
            ...
            // Credits Page
            add_management_page(
                __( 'The people that develop Redux Framework', 'redux-framework-starhotel' ), __( 'The people that develop Redux Framework', 'redux-framework-starhotel' ), $this->minimum_capability, 'redux-credits', array(
                    $this,
                    'credits_screen'
                )
            );
            ...
            // Status Page
            add_management_page(
                __( 'Redux Framework Status', 'redux-framework-starhotel' ), __( 'Redux Framework Status', 'redux-framework-starhotel' ), $this->minimum_capability, 'redux-status', array(
                    $this,
                    'status_screen'
                )
            );
            ...
            <h2 class="nav-tab-wrapper">
                <a class="nav-tab <?php echo $selected == 'redux-about' ? 'nav-tab-active' : ''; ?>"
                   href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'redux-about' ), 'tools.php' ) ) ); ?>">
                    <?php _e( "What's New", 'redux-framework-starhotel' ); ?>
                </a>
                <a class="nav-tab <?php echo $selected == 'redux-extensions' ? 'nav-tab-active' : ''; ?>"
                   href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'redux-extensions' ), 'tools.php' ) ) ); ?>">
                    <?php _e( 'Extensions', 'redux-framework-starhotel' ); ?>
                </a>
                <a class="nav-tab <?php echo $selected == 'redux-changelog' ? 'nav-tab-active' : ''; ?>"
                   href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'redux-changelog' ), 'tools.php' ) ) ); ?>">
                    <?php _e( 'Changelog', 'redux-framework-starhotel' ); ?>
                </a>
                <a class="nav-tab <?php echo $selected == 'redux-credits' ? 'nav-tab-active' : ''; ?>"
                   href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'redux-credits' ), 'tools.php' ) ) ); ?>">
                    <?php _e( 'Credits', 'redux-framework-starhotel' ); ?>
                </a>
                <a class="nav-tab <?php echo $selected == 'redux-support' ? 'nav-tab-active' : ''; ?>"
                   href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'redux-support' ), 'tools.php' ) ) ); ?>">
                    <?php _e( 'Support', 'redux-framework-starhotel' ); ?>
                </a>
                <a class="nav-tab <?php echo $selected == 'redux-status' ? 'nav-tab-active' : ''; ?>"
                   href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'redux-status' ), 'tools.php' ) ) ); ?>">
                    <?php _e( 'Status', 'redux-framework-starhotel' ); ?>
                </a>
            </h2>
        <?php
        }
        ...
        public function contributors() {
            ...
            foreach ( $contributors as $contributor ) {
                ...
                $contributor_list .= sprintf( '<a href="%s" title="%s" target="_blank">', esc_url( 'https://github.com/' . $contributor->login ), esc_html( sprintf( __( 'View %s', 'redux-framework-starhotel' ), $contributor->login ) )
                );
