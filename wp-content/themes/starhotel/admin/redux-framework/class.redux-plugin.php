<?php
    ...
    if ( ! class_exists( 'ReduxFrameworkPlugin' ) ) {
        ...
        class ReduxFrameworkPlugin {
             ...
             * @since       3.0.0
             */
            protected $plugin_slug = 'redux-framework-starhotel';
            ...
            private static function single_activate() {
                ...
                $notices[] = __( 'Redux Framework has an embedded demo.', 'redux-framework-starhotel' ) . ' <a href="./plugins.php?ReduxFrameworkPlugin=demo">' . __( 'Click here to activate the sample config file.', 'redux-framework-starhotel' ) . '</a>';
            ...
            public function add_action_links( $links ) {
                ...
                /**
                 * return array_merge(
                 *      array( 'redux_plugin_settings' => '<a href="' . admin_url( 'plugins.php?page=' . 'redux_plugin_settings' ) . '">' . __( 'Settings', 'redux-framework-starhotel' ) . '</a>' ),
                 *      $links
                 * );
                 */
            }
            ...
            public function plugin_metalinks( $links, $file ) {
                if ( strpos( $file, 'redux-framework.php' ) !== false && is_plugin_active( $file ) ) {
                    ...
                    $new_links = array(
                        '<a href="http://docs.reduxframework.com/" target="_blank">' . __( 'Docs', 'redux-framework-starhotel' ) . '</a>',
                        '<a href="https://github.com/ReduxFramework/redux-framework" target="_blank">' . __( 'Repo', 'redux-framework-starhotel' ) . '</a>',
                        '<a href="http://build.reduxframework.com/" target="_blank">' . __( 'Builder', 'redux-framework-starhotel' ) . '</a>',
                        '<a href="' . admin_url( 'tools.php?page=redux-support' ) . '">' . __( 'Get Support', 'redux-framework-starhotel' ) . '</a>',
                    );

                    if ( ( is_multisite() && $this->plugin_network_activated ) || ! is_network_admin() || ! is_multisite() ) {
                        if ( $this->options['demo'] ) {
                            $new_links[3] .= '<br /><span style="display: block; padding-top: 6px;"><a href="./plugins.php?ReduxFrameworkPlugin=demo" style="color: #bc0b0b;">' . __( 'Deactivate Demo Mode', 'redux-framework-starhotel' ) . '</a></span>';
                        } else {
                            $new_links[3] .= '<br /><span style="display: block; padding-top: 6px;"><a href="./plugins.php?ReduxFrameworkPlugin=demo" style="color: #bc0b0b;">' . __( 'Activate Demo Mode', 'redux-framework-starhotel' ) . '</a></span>';
                        }
                    }
