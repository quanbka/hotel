...
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=admin-folder-xclick&hosted_button_id=N5AD7TSH8YA5U
...
a custom theme based on [Starhotel2](http://underscores.me), [TGM](http://tgmpluginactivation.com), and [Redux](http://reduxframework.com), and any Redux arguments you want to set.
...
It is hard to continue development and support for this free plugin without contributions from users like you. If you enjoy using Redux Framework, and find it useful, please consider [making a donation](https://www.paypal.com/cgi-bin/webscr?cmd=admin-folder-xclick&hosted_button_id=MMFMHWUPKHKPW). Your donation will help encourage and support the plugin's continued development and better user support.
...
It has now a completely different code base. If you like what you see, realize this is a labor of love. Please [donate to the Redux Framework](https://www.paypal.com/cgi-bin/webscr?cmd=admin-folder-xclick&hosted_button_id=N5AD7TSH8YA5U) if you are able.
