                        ...
                        <div class="col-sm-12">
                            <?php if (true == $sh_redux['switch-header-breadcrumbs']) { ?>
                                <ol class="breadcrumb">
                                    ...
                                    <?php the_title('<li class="current">', '</li>'); ?>
                                </ol>
                            <?php } ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                ...
                $termsfilter = get_terms("tags", $args);
            ...
            <div class="row gallery">
                ...
                while ($gallery->have_posts()) {
                    ...
                    foreach ($images as $image) {
                        ...
                        // Get img details
                        echo "<div class='col-md-3 col-sm-3 col-xs-12 fadeIn appear mfp_open " . esc_html($res) . "' data-start='200'><a href='" . esc_url($image['full_url']) . "'><img src='" . esc_url($image['url']) . "' width='" . esc_attr($image['width']) . "'  alt='" . esc_attr($image['alt']) . "' title='" . esc_attr($image['alt']) . "' height='" . esc_attr($image['height']) . "' class='img-responsive zoom-img' /><i class='fa fa-search'></i></a></div>";
                        // Reset term array
                        unset($term_names);
                    }
                }
